  ...
  render() {
    ...
    this._letters = alphabet.map(letter => (
      <LetterPicker
        letter={letter}
        key={letter}
        alphabetFontStyle={this.props.alphabetFontStyle}
      />
    ))

    console.log('this.props.alphabetStyle ', this.props.alphabetStyle)
